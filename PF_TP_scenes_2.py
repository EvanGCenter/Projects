...
rnd.seed()
n_files = 360     # acutally number of pairs, or trials
break_time = 20              
datapath = 'C:\Python27\Scripts\data'                   # directory to save data in
impath = 'C:\Python27\Images\scenes\scenes_all'       #directory where images can be found
...
data_fname = 'time_scenes_' + exp_info['participant'] + '_' + exp_info['date']
